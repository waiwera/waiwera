...
!------------------------------------------------------------------------
  ...
  subroutine test_ncg_co2_henrys_constant
    ...
    if (rank == 0) then
       ...
       temperature = 20._dp
       expected = 1.45024014215750e+08_dp
