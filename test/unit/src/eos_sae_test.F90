...
#include <petsc/finclude/petsc.h>
  ...
  use fson_mpi_module
  use eos_sae_module
  use unit_test_utils_module, only: fluid_compare, single_phase_fluid_compare
    ...
    if (rank == 0) then
       associate (bulk => expected(1: 10), phase1 => expected(11: 19), &
         ...
         bulk = [30.009270056135245e6_dp, 400._dp, 3._dp, 0._dp, 4._dp, &
              1._dp, 0.64571208174049777_dp, 3._dp, 30.009270056135245e6_dp, 0._dp]
         ...
         bulk = [63.956158699122846e6_dp, 460._dp, 3._dp, 0._dp, 4._dp, 1._dp, &
              0.57215284366576902_dp, 3._dp, 55.956158699122846e6_dp, 8.e6_dp]
  ...
  subroutine test_eos_sae_fluid_continuity(test)
    ...
    if (rank == 0) then
       ...
       associate (d1 => primary1(1), T1 => primary1(2), &
            Pa1 => primary1(3), d2 => primary2(1), T2 => primary2(2), &
            Pa2 => primary2(3))
