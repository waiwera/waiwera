...
!------------------------------------------------------------------------
  ...
  subroutine test_eos_sge_transition(test)
    ...
    if (rank == 0) then
       ...
       fluid%region = old_fluid%region
       expected_region = 3
       expected_primary = [510.39357796383666_dp, 362.91788401553890_dp, 0._dp]
       expected_transition = PETSC_TRUE
       expected_err = 0
       ...
       fluid%region = old_fluid%region
       expected_region = 3
       expected_primary = [510.39357796383666_dp, 362.91788401553890_dp, 5.e5_dp]
       expected_transition = PETSC_TRUE
       expected_err = 0
       ...
       fluid%region = old_fluid%region
       expected_region = 3
       expected_primary = [315.09804898529796_dp, 373.94040546576900_dp, 0._dp]
       expected_transition = PETSC_TRUE
       expected_err = 0
       ...
       fluid%region = old_fluid%region
       expected_region = 3
       expected_primary = [315.09804898529796_dp, 373.94040546576900_dp, 3.e5_dp]
       expected_transition = PETSC_TRUE
       expected_err = 0
       ...
       fluid%region = old_fluid%region
       expected_region = 2
       expected_primary = [16.528694506565429e6_dp, 350.00000000000387_dp, 0._dp]
       expected_transition = PETSC_TRUE
       expected_err = 0
       ...
       fluid%region = old_fluid%region
       expected_region = 2
       expected_primary = [17.1286945066e6_dp, 350.00000000000387_dp, 6.e5_dp]
       expected_transition = PETSC_TRUE
       expected_err = 0
